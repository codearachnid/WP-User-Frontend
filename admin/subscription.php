            ...
            if ( $packs ) {
                ...
                foreach ($packs as $row) {
                    ...
                    <tr valign="top" <?php echo ( ($count % 2) == 0) ? 'class="alternate"' : ''; ?>>
                        ...
                        <td>
                            <a href="<?php echo wp_nonce_url( add_query_arg( array('action' => 'edit', 'pack_id' => $row->id), $this->baseurl, 'wpuf_pack_edit' ) ); ?>"><img src="<?php echo plugins_url( 'images/edit.png', dirname( __FILE__ ) ); ?>"</a>
                            <a href="<?php echo wp_nonce_url( add_query_arg( array('action' => 'del', 'id' => $row->id), $this->baseurl ), 'wpuf_pack_del' ); ?>" onclick="return confirm('<?php _e( 'Are you sure to delete this pack?', 'wpuf' ); ?>');"><img src="<?php echo plugins_url( 'images/del.png', dirname( __FILE__ ) ); ?>"</a>
                        </td>
